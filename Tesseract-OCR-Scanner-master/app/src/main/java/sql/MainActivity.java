...
/**
 * Created by yutianyuan on 2018/3/17.
 */
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private static final int Camera_RESULTCODE = 4;

    private static final int Camera_REQUESTCODE=4;
    ...
    public void camera() {
        Intent intent =new Intent(MainActivity.this, com.zl.tesseract.scanner.ScannerActivity.class);
